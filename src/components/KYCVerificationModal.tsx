            ...
            <div className="space-y-3">
              <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                ...
                <p className="text-gray-300 text-xs mb-3 text-center leading-relaxed">
                  Para garantir a seguranca da sua conta, precisamos confirmar que voce e o titular da chave PIX cadastrada.
                </p>
                ...
                <div className="bg-blue-500/10 rounded-lg p-3 mb-3 border border-blue-500/30">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="text-blue-300 font-bold text-xs mb-2">Como funciona:</h4>
                      <ul className="text-blue-200 text-[10px] space-y-1.5 leading-relaxed">
                        <li className="flex items-start gap-1.5">
                          <span className="text-blue-400 mt-0.5">•</span>
                          <span>Faca um deposito de qualquer valor via PIX</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-blue-400 mt-0.5">•</span>
                          <span>Verificamos automaticamente se a chave PIX usada e a mesma cadastrada</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-blue-400 mt-0.5">•</span>
                          <span>Apos confirmacao, o valor depositado e creditado no seu saldo</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-blue-400 mt-0.5">•</span>
                          <span>Voce podera sacar todo o seu saldo disponivel</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-2.5 mb-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="text-green-300 font-bold text-xs mb-1">Valor 100% creditado</h4>
                      <p className="text-green-200 text-[10px] leading-relaxed">
                        O deposito sera adicionado ao seu saldo imediatamente apos a verificacao
                      </p>
                    </div>
                  </div>
                </div>

                <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-2.5 mb-3">
                  <div className="flex items-start gap-2">
                    <Shield className="w-4 h-4 text-orange-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="text-orange-300 font-bold text-xs mb-1">Por que verificamos?</h4>
                      <p className="text-orange-200 text-[10px] leading-relaxed">
                        Esta etapa e obrigatoria por lei para prevenir fraudes e garantir que apenas voce tenha acesso ao saldo
                      </p>
                    </div>
                  </div>
                </div>
